...
int print_binary(unsigned int n,int field_width );
int print_unsigned(va_list args, int flags, int length,int field_width );
int print_octal(va_list args, int flags, int length,int field_width );
int print_hex(va_list args, int uppercase, int flags, int length, int field_width );
